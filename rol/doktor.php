          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop2">
                <li role="presentation"><p align="center">Kullanici adi</p>
                <img src="../assets/images/resim5.jpg" width="100px" height="50px"></li>
              	<li role="presentation" class="divider"></li>
                <li role="presentation"><a id="doktor_ekle" role="menuitem" tabindex="-1" href="http://twitter.com/fat">Doktor Ekle</a></li>
